...
function scenario_one() {
    ...
    let elementPost = cy.xpath('/html[1]/body[1]/div[2]/div[1]/nav[1]/div[1]/section[1]/div[1]/ul[2]/li[1]/a[1]');
    elementPost.click({force: true});

    cy.wait(1000);

    let buttonElement = cy.xpath('/html[1]/body[1]/div[2]/div[1]/nav[1]/div[1]/section[1]/div[1]/ul[2]/li[1]/a[2]/span[1]/*[name()=\'svg\'][1]');
    buttonElement.click({force: true});

    cy.wait(1000);

    let elementTitle = cy.xpath('//textarea[@placeholder=\'Post title\'][@class=\'gh-editor-title ember-text-area gh-input ember-view\']');
    elementTitle.type('My first post', {force: true});

    cy.wait(1000);

    let elementParraf = cy.xpath('/html[1]/body[1]/div[2]/div[1]/main[1]/div[1]/section[1]/div[1]/div[1]/article[1]/div[1]/div[1]');
    elementParraf.click({force: true});
    elementParraf.type('Lorem Ipsum is simply dummy text of the printing and typesetting industry. ', {force: true});

    cy.wait(2000);

    let elementMenu = cy.xpath('/html[1]/body[1]/div[2]/div[1]/main[1]/div[1]/section[1]/header[1]/section[1]/div[2]/div[1]/span[1]');
    elementMenu.click({force: true});

    cy.wait(1000);

    let elementButtonPublish = cy.xpath('/html[1]/body[1]/div[1]/div[1]/footer[1]/button[2]/span[1]');
    elementButtonPublish.click({force: true});

    let elementButtonConfirm = cy.xpath('//button[@class=\'gh-btn gh-btn-black gh-btn-icon ember-view\']');
    ...
    let elementList = cy.xpath('/html[1]/body[1]/div[2]/div[1]/main[1]/section[1]/div[1]/header[1]/section[1]/div[1]/div[1]/div[1]/span[1]');
...
function scenario_two() {
    ...
    let elementTitle = cy.xpath('//textarea[@placeholder=\'Post title\'][@class=\'gh-editor-title ember-text-area gh-input ember-view\']');
    elementTitle.type('This is my first my post programmed !!!', {force: true});
    ...
    let elementChangeCheck = cy.xpath('/html[1]/body[1]/div[1]/div[1]/div[1]/section[1]/div[1]/div[2]/div[2]/div[1]');
...
function scenario_three() {
    ...
    let elementTitleChange = cy.xpath('//textarea[@placeholder=\'Post title\'][@class=\'gh-editor-title ember-text-area gh-input ember-view\']');
...
function search() {
    let elementTools = cy.xpath('/html[1]/body[1]/div[2]/div[1]/main[1]/button[1]/span[1]');
    elementTools.click({force: true});

    cy.wait(3000);

    cy.xpath('/html[1]/body[1]/div[2]/div[1]/main[1]/div[1]/div[1]/div[1]/div[1]/div[2]/form[1]/div[1]/p[1]')
        .invoke('text')
        .then(text => {
