...
Scenario: Crear webhook
    ...
    Then I take a screenshot
    And I wait for 1 seconds    
    And I click "add webhook" in ".gh-canvas > div a[href*='#/settings']"
    ...
    And I wait for 2 seconds    
    And I validate "webhook created name" "tests" "//html/body/div[2]/div/main/section/div/table/tbody/tr[last()]/td"
    Then I take a screenshot
...
Scenario: Editar integración
    ...
    Then I take a screenshot
    And I click "save integration" in ".gh-canvas-header button"
    And I wait for 3 seconds    
    Given I navigate to page "http://localhost:3001/ghost/#/settings/integrations"
    And I validate "integration name" "pruebas" ".apps-grid-container:last-child .apps-grid .apps-grid-cell:first-child .apps-card-app-title"
    Then I take a screenshot
...
Scenario: Eliminar integración
    ...
    Then I take a screenshot
    And I wait for 3 seconds    
    And I click "delete integration" in "//html/body/div[2]/div/main/section/button"
    Then I take a screenshot
    And I wait for 1 seconds    
